...
#S3 settings
AWS_ACCESS_KEY_ID = os.environ.get("S3_ACCESS_KEY", "xVPCUFjCJccX4xe9YXaM")
AWS_SECRET_ACCESS_KEY = os.environ.get("S3_SECRET_KEY", "IeryMD9USTv60AbJympCuZvYgPSDbt6KgKHAyga9")
