...
class Articles(models.Model):
    ...
    annotation = models.CharField(max_length=255, verbose_name="Аннотация", blank=True)
    ...
    review = models.IntegerField(validators=[MinValueValidator(-2), MaxValueValidator(2)], null=True)
